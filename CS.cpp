// version for display E40201LF 4 digist and 2 LED - wihtout key
...
void CS1694::LED1(bool LEDstate){
	bitWrite(displayMem[3],0,LEDstate);
	}
void CS1694::LED2(bool LEDstate){
	bitWrite(displayMem[2],7,LEDstate);
	}
...
void CS1694::colon1(bool LEDstate){
	bitWrite(displayMem[6],3,LEDstate);
	}
void CS1694::colon2(bool LEDstate){
	bitWrite(displayMem[10],3,LEDstate);
	}
